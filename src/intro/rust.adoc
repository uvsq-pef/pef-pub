...
== Le langage Rust
* Conçu et développé par Graydon Hoare (Mozilla Research) depuis 2010
...
* L'initialisation d'un projet Rust s'appuie sur `cargo`
+
[source,bash]
----
$ cargo new hello
...
** en utilisant une `Range`, on peut manipuler des indices
