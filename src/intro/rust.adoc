...
* Une unité de compilation Rust est dénommée un https://doc.rust-lang.org/stable/reference/crates-and-source-files.html[_crate_] (_caisse_)
...
TIP: Expérimentez (https://github.com/rust-lang/rustlings/tree/main/exercises/primitive_types[rustlings], https://practice.rs/basic-types/numbers.html[Rust By Practice])
...
TIP: Expérimentez (https://github.com/rust-lang/rustlings/tree/main/exercises/variables[rustlings], https://practice.rs/variables.html[Rust By Practice])
...
TIP: voir l'exemple sur les chaînes de caractères

== Slice
* Un https://doc.rust-lang.org/book/ch04-03-slices.html[_slice_] (`[T]`) est un type primitif permettant de référencer une portion d'une séquence contiguë d'éléments
** c'est une vue sur un bloc de mémoire représentée par un pointeur et une taille
** cf. le type primitif https://doc.rust-lang.org/std/primitive.slice.html[slice]
** cf. le module https://doc.rust-lang.org/std/slice/index.html[`std::slice`]
...
* Expérimentez (https://practice.rs/compound-types/slice.html[Rust By Practice])
====
...
=== Type primitif https://doc.rust-lang.org/1.54.0/std/primitive.str.html[`str`]
* Le type primitif https://doc.rust-lang.org/1.54.0/std/primitive.str.html[`str`] est un slice de type `[u8]` (séquence d'octet)
...
* Le module https://doc.rust-lang.org/std/str/index.html[std::str] permet la manipulation des variables de ce type
* Quelques opérations :
https://doc.rust-lang.org/std/primitive.str.html#method.chars[`chars`],
https://doc.rust-lang.org/std/primitive.str.html#method.contains[`contains`],
https://doc.rust-lang.org/std/primitive.str.html#method.find[`find`],
https://doc.rust-lang.org/std/primitive.str.html#method.get[`get`]
https://doc.rust-lang.org/std/primitive.str.html#method.is_empty[`is_empty`],
https://doc.rust-lang.org/std/primitive.str.html#method.len[`len`],
https://doc.rust-lang.org/std/primitive.str.html#method.replace[`replace`],
https://doc.rust-lang.org/std/primitive.str.html#method.split[`split`],
https://doc.rust-lang.org/std/primitive.str.html#method.trim[`trim`]
...
=== Type https://doc.rust-lang.org/std/string/struct.String.html[std::string::String]
* Le type https://doc.rust-lang.org/std/string/struct.String.html[std::string::String] est le type chaîne de caractères proposé par la bibliothèque standard
* Une instance de ce type possède la propriété du contenu de la chaîne
* Quelques opérations :
https://doc.rust-lang.org/std/string/struct.String.html#method.new[`new`],
https://doc.rust-lang.org/std/string/struct.String.html#method.with_capacity[`with_capacity`],
https://doc.rust-lang.org/std/string/struct.String.html#impl-From%3C%26str%3E[`from`],
https://doc.rust-lang.org/std/string/struct.String.html#method.capacity[`capacity`],
https://doc.rust-lang.org/std/string/struct.String.html#method.clear[`clear`],
https://doc.rust-lang.org/std/string/struct.String.html#method.insert[`insert`],
https://doc.rust-lang.org/std/string/struct.String.html#method.is_empty[`is_empty`],
https://doc.rust-lang.org/std/string/struct.String.html#method.len[`len`],
https://doc.rust-lang.org/std/string/struct.String.html#method.push_str[`push_str`],
https://doc.rust-lang.org/std/string/struct.String.html#impl-Add%3C%26str%3E[`+`] (concaténation),
...
TIP: Expérimentez (https://github.com/rust-lang/rustlings/tree/main/exercises/strings[rustlings], https://practice.rs/compound-types/string.html[Rust By Practice])
...
TIP: Expérimentez (https://github.com/rust-lang/rustlings/tree/main/exercises/if[rustlings], https://practice.rs/flow-control.html[Rust By Practice])
...
TIP: Expérimentez (https://github.com/rust-lang/rustlings/tree/main/exercises/functions[rustlings], https://practice.rs/basic-types/functions.html[Rust By Practice])
...
TIP: Expérimentez (https://github.com/rust-lang/rustlings/tree/main/exercises/modules[rustlings])
...
https://doc.rust-lang.org/std/primitive.tuple.html[`Tuple`]:: une séquence finie et hétérogène d'éléments (littéral `("hello", 5, 'c')`) (https://practice.rs/compound-types/tuple.html[Rust By Practice])
https://doc.rust-lang.org/1.54.0/std/primitive.array.html[`Tableau`]:: un tableau de taille fixe d'éléments de même type (littéral `[x, y, z]` ou `[x; N]`) (https://practice.rs/compound-types/array.html[Rust By Practice])
https://doc.rust-lang.org/std/vec/struct.Vec.html[`Vec<T>`]:: un tableau de taille variable (https://github.com/rust-lang/rustlings/tree/main/exercises/vecs[rustlings], https://practice.rs/collections/vector.html[Rust By Practice])
https://doc.rust-lang.org/std/result/index.html[`Result<T, E>`]:: pour retourner et propager une erreur (https://practice.rs/result-panic/result.html[Rust By Practice])
https://doc.rust-lang.org/std/option/index.html[`Option<T>`]:: pour représenter une valeur optionnel (https://github.com/rust-lang/rustlings/tree/main/exercises/options[rustlings])
https://doc.rust-lang.org/std/collections/index.html[std::collections]:: manipulation de collections
https://doc.rust-lang.org/std/fmt/index.html[std::fmt]:: formatage de chaînes de caractères (https://practice.rs/formatted-output/formatting.html[Rust By Practice])
...
** https://practice.rs/why-exercise.html[Rust by practice]
